...
\acknowledgements{Składam serdeczne podziękowania \break dr. inż. Mateuszowi Ślażyńskiemu za opiekę naukową podczas realizacji pracy.}
...
\begin{document}
    ...
    \include{rozdzialy/wprowadzenie}
    \include{rozdzialy/algorytmy}
    \include{rozdzialy/eksperymenty}
    \include{rozdzialy/wyniki}
